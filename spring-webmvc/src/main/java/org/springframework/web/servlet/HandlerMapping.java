 ...
 * 主要有两种实现
 * 第一种：request-bean  比如"/test"的请求会映射到加上@Component("/test")这个注解并且实现了Controller接口的bean
 * 其底层存了一个key为request，value为bean的map
 * @see org.springframework.web.servlet.mvc.Controller
 * @see org.springframework.web.servlet.handler.BeanNameUrlHandlerMapping
 * 第二种: request-method 就是我们常用的@RequestMapping注解，请求会被映射到具体的方法
 * 其底层存了一个key为request，value为method的map
